import{_ as s,c as n,o as a,d as p}from"./app.58c7925b.js";const C=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/手写/列表转成树形结构.md"}'),l={name:"Interview/手写/列表转成树形结构.md"},o=p(`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#F6F6F4;">[</span></span>
