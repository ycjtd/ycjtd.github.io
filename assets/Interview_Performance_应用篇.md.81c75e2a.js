import{_ as s,c as n,o as a,d as l}from"./app.72c7cb6e.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":3,"title":"懒加载","slug":"懒加载","link":"#懒加载","children":[]},{"level":3,"title":"防抖与节流","slug":"防抖与节流","link":"#防抖与节流","children":[]}],"relativePath":"Interview/Performance/应用篇.md"}'),p={name:"Interview/Performance/应用篇.md"},o=l(`<h3 id="懒加载" tabindex="-1">懒加载 <a class="header-anchor" href="#懒加载" aria-hidden="true">#</a></h3><p>针对图片加载时机的优化，在一些图片量比较大的网站，如果尝试在用户打开页面的时候，就把所有的图片资源加载完毕，那么很可能会造成白屏、卡顿等现象，因为图片太多了，浏览器可能做不到一次性处理那么多的任务。实际上，用户点开页面的瞬间，能看到的只有首屏的东西，只要我们在页面打开的时候把首屏的资源加载出来，用户就会认为页面是没问题的，下面的图片，可以等到用户下拉的瞬间再去请求，这个就是懒加载。</p><p>懒加载的实现有两个关键的数值：一个是当前可视区域的高度 <code>const viewHeight = window.innerHeight || document.documentElement.clientHeight ​</code>，另一个是元素距离可视区域顶部的高度 <code>getClientRects()</code> 来获取元素的大小以及相对于视口的位置.</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#F6F6F4;">  &lt;</span><span style="color:#F286C4;">script</span><span style="color:#F6F6F4;">&gt;</span></span>
