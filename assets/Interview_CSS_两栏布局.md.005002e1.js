import{_ as s,c as n,o as a,d as l}from"./app.58c7925b.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/CSS/两栏布局.md"}'),p={name:"Interview/CSS/两栏布局.md"},o=l(`<p><strong>一栏固定宽度，右边一栏宽度自适应 1.利用浮动，左边元素定宽 200px，向左浮动(float:left)，右边元素 margin-left:200px，宽度设置为 auto(默认为 auto，撑满整个盒子)</strong></p><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki dracula-soft vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#62E884;font-style:italic;">.left</span><span style="color:#F6F6F4;"> {</span></span>
