import{_ as s,c as n,o as a,a as l}from"./app.d0de5917.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/手写/LRU.md"}'),p={name:"Interview/手写/LRU.md"},o=l(`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#7B7F8B;">// 缓存淘汰策略，移除最近最少被访问的数据项</span></span>
