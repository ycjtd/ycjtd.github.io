import{_ as s,c as n,o as a,d as l}from"./app.eeaca755.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/手写/并行限制的Promise调度器.md"}'),p={name:"Interview/手写/并行限制的Promise调度器.md"},o=l(`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#7B7F8B;">// 递归的方法</span></span>
