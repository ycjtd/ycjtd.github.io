import{_ as s,c as n,o as a,a as l}from"./app.d0de5917.js";const C=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Interview/手写/树形结构转换成列表.md"}'),p={name:"Interview/手写/树形结构转换成列表.md"},o=l(`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#F6F6F4;">[</span></span>
